...
![Original illustration, please feel free to use](/assets/img/batteries.png)
...
![Illustration from https://doi.org/10.1038/s43588-021-00041-y](/assets/img/LLZO_Li.png)

> Interfacial kinetics control the Lithium stripping and deposition during cell operations. This typically involves transport through interfacial layers, and the charge transfer reaction. However direct experimental measurements on the latter are extremely difficult due to convolution from interfacial layers. All solid-state lithium metal batteries employing densely sinterered oxides offer the possibility of peeking into the reaction kinetics, which we are attempting to do. In theory (Gao et al, <i>Advanced Energy and Simulation</i>, 2019), the process is expected to offer very low resistance, which has seen indirect verification on atomically smooth monocrystalline samples (Krauskopf et al, Advanced Energy Materials, 2021). However can its limits be determined for polycrystalline samples? Furthermore, how <i>fast</i> can the charge transfer reaction be? <i>Read more in upcoming study with Ajeet & Phani </i>.

## Electro-chemo-mechanical coupling in batteries.

![Illustration from https://doi.org/10.1038/s41467-024-52123-w](/assets/img/chemomechanics.png)
